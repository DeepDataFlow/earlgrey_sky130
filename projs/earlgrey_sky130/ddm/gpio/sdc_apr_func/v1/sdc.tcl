# gpio APR SDC constraints (200MHz)
...
set_input_delay 1 -clock clk_i [get_ports {cio_gpio_i[*]}]
set_input_delay 1 -clock clk_i [get_ports {alert_rx_i[*]}]

# --- Output Delays ---
set_output_delay 1 -clock clk_i [get_ports {tl_o[*]}]
set_output_delay 1 -clock clk_i [get_ports {sampled_straps_o[*]}]
set_output_delay 1 -clock clk_i [get_ports {racl_error_o[*]}]
set_output_delay 1 -clock clk_i [get_ports {intr_gpio_o[*]}]
set_output_delay 1 -clock clk_i [get_ports {cio_gpio_o[*]}]
set_output_delay 1 -clock clk_i [get_ports {cio_gpio_en_o[*]}]
